...
Prompts = [
    ...
    Prompt(
        name="rephrase",
        text="Rephrase all my messages into a more appropriate and grammatically correct form. Answer only by paraphrased sentences without any additional information.",
    ),
    Prompt(
        name="debug", text="Find all errors and bugs in my code. Attempt to clarify each mistake in a stepwise manner."
    ),
]

PromptsMap = {_.name: _ for _ in Prompts}
