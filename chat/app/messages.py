...
from app.models import Model, GPT_4o_mini
...
class Chat:
    ...
    model: Model = field(default=GPT_4o_mini)
    ...
    def _price(self) -> float:
        price = self.model.price.input * self._tokens.get("prompt_tokens", 0) + self.model.price.output * (
            self._tokens.get("total_tokens", 0) - self._tokens.get("prompt_tokens", 0)
        )
